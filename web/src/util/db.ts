        ...
        tables: [
            {
                name: TABLE_NAME,
                columns: {
                    latitude: { dataType: "number", enableSearch: false },
                    longitude: { dataType: "number", enableSearch: false },
                    altitude: { dataType: "number", enableSearch: false },
                    speed: { dataType: "number", enableSearch: false },
                    accuracy: { dataType: "number", enableSearch: false },
                    verticalAccuracy: { dataType: "number", enableSearch: false },
                    speedAccuracy: { dataType: "number", enableSearch: false },
